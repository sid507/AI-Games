...
gameicon = pygame.image.load('PlayerGame/goal.png')
...
victory=pygame.image.load("PlayerGame/victory.png")
#goal=pygame.image.load("goal.png")
og_goal=pygame.image.load("PlayerGame/goal.png")
goal=og_goal.copy()
goalrect=goal.get_rect()
goalrect=goalrect.move([650,125])
level=pygame.image.load("PlayerGame/level.png").convert()
og_player = pygame.image.load("PlayerGame/player.png")
